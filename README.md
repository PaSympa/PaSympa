...
[**discord-mcp**](https://github.com/PaSympa/discord-mcp) — A 43-tool MCP server that lets AI assistants control Discord: messages, channels, roles, permissions, members, and moderation.
